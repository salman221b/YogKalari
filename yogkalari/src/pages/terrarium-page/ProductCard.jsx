...
const ProductCard = () => {
  ...
  return (
    <section className="bg-[#F6F3EB] py-10">
      <div className="max-w-full mx-auto px-5 sm:px-7 lg:px-14">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <h1 className="text-3xl md:text-4xl font-bold text-[#084C2E]">Terrariums</h1>
            ...
            <div className="flex items-center space-x-2">
              <div className="relative w-full md:w-96">
                ...
                />
                <img src="/Search.png" alt="Search" className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
              </div>
              ...
              <div className="grid gap-8 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
                {currentProducts.map((product) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="text-md md:text-lg text-gray-900 leading-tight font-semibold">{product.name}</h3>
                      <p className="text-sm md:text-md mt-1">({product.category})</p>
                      <p className="font-semibold mt-2 text-md md:text-lg">
                        <img src="/AED.png" alt="AED" className="inline w-5 h-5 md:w-6 md:h-6 mr-1 mb-1" />
      ...
      <RecommendationSlider products={products.filter((p) => p.isRecommended)} />
      <div className="mt-10">
        <Marquee />
      </div>
    </section>
