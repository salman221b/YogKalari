...
import PnP from "../assets/PnP.pdf";
import Inst from "../assets/TerarriumsInstructions.pdf";
const YogaFooter = () => {
  return (
    <footer className="bg-[#F5F2EB] pt-12 sm:pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-1 space-y-4 text-center sm:text-left">
            ...
            <div className="flex space-x-8 justify-center sm:justify-start">
              ...
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 bg-[#2F2F2F] rounded-lg flex items-center justify-center hover:bg-[#78756D] transition-colors duration-300 flex-shrink-0"
                aria-label="WhatsApp"
              >
                <svg
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a
                  ...
                  className="text-gray-600 transition-colors text-sm block"
                >
                  Write to Us
                </a>
              </li>
        ...
        {/* Footer Bottom */}
        <div className="mt-8 sm:mt-12 pt-4 sm:pt-6 text-center pb-5">
